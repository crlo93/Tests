...
public class BrazoIObtener : MonoBehaviour
{
    private string url;
    ...
    List<string> PiezasBrazoI = new List<string>();
    ...
    void Start()
    {
        url = "http://robo-fightworld.bigbang.uno/api/ObtenerPiezas/PartArmL.php";
        getData();
        ...
        if (www.error == null)
        {
            ...
            else
            {
                ...
                foreach (JSONValue item in json["DATA"].Array)
                {
                    ...
                    PiezasBrazoI.Add(data["prt_name"].Str);
