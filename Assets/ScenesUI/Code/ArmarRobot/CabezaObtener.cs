...
public class CabezaObtener: MonoBehaviour
{
    private string url;
    ...
    List<string> PiezasHead = new List<string>();
    ...
    void Start()
    {
        url = "http://robo-fightworld.bigbang.uno/api/ObtenerPiezas/PartHead.php";
        getData();
        ...
        if (www.error == null)
        {
            ...
            else
            {
                ...
                foreach (JSONValue item in json["DATA"].Array)
                {
                    ...
                    PiezasHead.Add(data["prt_name"].Str);
