...
public class CuerpoObtener : MonoBehaviour
{
    private string url;
    ...
    List<string> PiezasCuerpo = new List<string>();
    ...
    void Start()
    {
        url = "http://robo-fightworld.bigbang.uno/api/ObtenerPiezas/PartBody.php";
        getData();
        ...
        if (www.error == null)
        {
            ...
            else
            {
                ...
                foreach (JSONValue item in json["DATA"].Array)
                {
                    ...
                    PiezasCuerpo.Add(data["prt_name"].Str);
